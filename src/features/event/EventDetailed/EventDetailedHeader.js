...
const EventDetailedHeader = ({event, loading, isHost, isGoing, goingToEvent, cancelGoingToEvent}) => {
    return (
        <Segment.Group>
                ...
                <Segment basic style={eventImageTextStyle}>
                    <Item.Group>
                        ...
                        <Item.Content>
                            ...
                            <p>
                                Hosted by <strong><Link to={`/events/${event.hostUid}`} style={{color: 'white'}} > {event.hostedBy} </Link></strong>
                            </p>
                        </Item.Content>
                    </Item>
                    </Item.Group>
